...
=======
const FAIL = (_chalk || _load_chalk()).default.supportsColor
  ? (_chalk || _load_chalk()).default.reset.inverse.bold.red(` ${FAIL_TEXT} `)
  : FAIL_TEXT;
...
=======
  ...
  return (
    `${status} ${projectDisplayName}${(0,
    (_utils || _load_utils()).formatTestPath)(
