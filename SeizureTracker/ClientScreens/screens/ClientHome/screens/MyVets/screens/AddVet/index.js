...
import SubmitVet from './SubmitVet';
import DatePicker from 'react-native-datepicker'
import { Header } from 'react-navigation';

const background = require('../../../../../../../assets/background.png');

export default class AddVet extends Component{
      ...
      return(
        ...
        <ScrollView>
            <View style={styles.container}>
                <Text style={styles.create}>Please enter your veterinarian's unique identifier: </Text>
                    <InputField
