...
export default class OtherLogInfo extends Component{
    ...
    render() {
        ...
        const otherLogObj = navigation.getParam('otherLogObj', 'Error: no log found');
          ...
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center'}}>
            <View style={[styles.viewStyle, shadowStyle]}>
              <View style={{ flex: 1, alignItems: 'center', flexDirection: 'column', justifyContent: 'flex-start', marginTop: h(.5)}}>
                  <Text style={{ color:'white', fontSize: totalSize(3)}}>Other Log: {otherLogObj.logType}</Text>
                  ...
                  <View style={{ flex: 1, alignItems: 'flex-start', flexDirection: 'row', justifyContent: 'flex-start', marginLeft: w(1.5),
                    ...
                    <View style={styles.row1}>
                        <Text style={styles.textField}>Event: <Text style={styles.textCus}>{otherLogObj.date}</Text> </Text>
                        <Text style={styles.textField}>Date: <Text style={styles.textCus}>{otherLogObj.logType}</Text> </Text>
                    </View>
                  ...
                  <View style={{flex: 1, flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'flex-start', marginLeft: w(1)}}>
                    <Text style={styles.textField2}>Description: <Text style={styles.textCus}>{otherLogObj.details}</Text></Text>
                  </View>
              </View>
            </View>
          </View>
