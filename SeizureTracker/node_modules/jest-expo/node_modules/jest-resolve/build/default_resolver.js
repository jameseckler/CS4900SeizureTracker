...
=======
    const resolveTarget = (_path || _load_path()).default.resolve(
      basedir,
      target
    );
>>>>>>> master
...
=======
    const dirs = (0,
    (_node_modules_paths || _load_node_modules_paths()).default)(basedir, {
      moduleDirectory: options.moduleDirectory,
      paths: paths
    });
    for (let i = 0; i < dirs.length; i++) {
      const resolveTarget = (_path || _load_path()).default.join(
        dirs[i],
        target
      );
>>>>>>> master
...
function isCurrentDirectory(testPath) {
  return (
    ...
    (_path || _load_path()).default.resolve(testPath)
  );
}
>>>>>>> master
