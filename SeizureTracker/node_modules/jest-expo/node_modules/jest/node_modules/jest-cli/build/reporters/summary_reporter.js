...
=======
  return (_get_result_header = _interopRequireDefault(
    require('./get_result_header')
  ));
>>>>>>> master
}
...
=======
  return (_get_snapshot_summary = _interopRequireDefault(
...
class SummaryReporter extends (_base_reporter || _load_base_reporter())
  .default {
>>>>>>> master
...
=======
      ...
      if (numTotalTestSuites) {
        let message = (0, (_utils || _load_utils()).getSummary)(
          aggregatedResults,
          {
            estimatedTime: this._estimatedTime
          }
...
=======
      const snapshotSummary = (0,
      (_get_snapshot_summary || _load_get_snapshot_summary()).default)(
        snapshots,
        globalConfig,
        updateCommand
      );
...
=======
    if (
      ...
      this.log(
        (_chalk || _load_chalk()).default.bold('Summary of all failing tests')
      );
>>>>>>> master
...
=======
          this._write(
            (0, (_get_result_header || _load_get_result_header()).default)(
              testResult,
              globalConfig
            ) +
              '\n' +
...
=======
      testInfo = (_chalk || _load_chalk()).default.dim(
...
=======
    ...
    const contextInfo =
      contexts.size > 1
        ? (_chalk || _load_chalk()).default.dim(' in ') +
          contexts.size +
          (_chalk || _load_chalk()).default.dim(' projects')
        : '';
